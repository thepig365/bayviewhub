...
export const metadata: Metadata = genMeta({
  ...
  description: '以中文进入 Mendpress 的视觉叙事栏目；田野笔记与图像主导的条目在具备中文内容时会直接显示中文版本。',
...
export default function ChineseMendpressVisualNarrativePage() {
  return (
    <JournalCollectionPage
      ...
      eyebrow="Mendpress"
      title="视觉叙事"
      intro="这一栏聚焦以图像、场所、节奏与氛围推进的写作。凡已准备中文标题、摘要与正文的条目，都会在这里以中文阅读模式呈现。"
      types={['field_note']}
      ...
      emptyBody="当第一篇视觉叙事或田野笔记发布后，这里会显示该栏目的中文阅读入口。"
