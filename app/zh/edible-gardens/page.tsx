      ...
      <section className="bg-gradient-to-br from-primary-50 to-natural-50 py-20 md:py-28 dark:from-neutral-900 dark:to-neutral-800">
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-6 text-xl leading-relaxed text-fg/80 dark:text-white/80">
        ...
        <div className="container mx-auto px-4">
          <div className="mx-auto grid max-w-5xl gap-8 md:grid-cols-3">
            <div className="rounded-2xl bg-natural-50 p-6 dark:border dark:border-border dark:bg-surface/50">
              ...
              <p className="mt-3 leading-8 text-fg/80 dark:text-white/80">围绕花园订阅、季节性收成、家庭友好活动日与现场体验，形成一个稳定而有人味的项目。</p>
            </div>
            <div className="rounded-2xl bg-natural-50 p-6 dark:border dark:border-border dark:bg-surface/50">
              <h2 className="font-serif text-2xl font-semibold text-fg">为什么重要</h2>
              <p className="mt-3 leading-8 text-fg/80 dark:text-white/80">它让食物重新和土地、季节、关系与日常生活发生连接，而不只是成为一个消费终点。</p>
            </div>
            <div className="rounded-2xl bg-natural-50 p-6 dark:border dark:border-border dark:bg-surface/50">
              <h2 className="font-serif text-2xl font-semibold text-fg">适合谁</h2>
              <p className="mt-3 leading-8 text-fg/80 dark:text-white/80">适合家庭、重视食物来源的人、喜欢花园实践的人，也适合想和孩子一起参与更真实节奏的人。</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-2xl">
            <div className="mb-10 text-center">
              ...
              <p className="mt-4 text-fg/80 dark:text-white/80">如果你想在项目开放时第一时间收到消息，可以通过这里进入 Bayview Notes。</p>
            </div>
            <div className="rounded-2xl bg-white p-8 dark:border dark:border-border dark:bg-surface">
              <NewsletterForm locale="zh" />
            </div>
            <div className="mt-8 flex flex-wrap justify-center gap-4">
              <Button href={localizedHref('/partners/founding', 'zh')} variant="primary" size="lg">
                查看创始合作路径
              </Button>
