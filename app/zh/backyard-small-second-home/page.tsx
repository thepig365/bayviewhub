      ...
      <section className="border-b border-border bg-natural-50 py-16 dark:border-neutral-800 dark:bg-neutral-900">
        <div className="container mx-auto px-4">
          <div className="mx-auto max-w-4xl">
            <p className="eyebrow text-accent">Backyard Small Second Home</p>
            <h1 className="mt-4 text-4xl font-serif font-bold leading-tight text-fg md:text-5xl">
              什么是 Victorian Backyard Small Second Home？
            </h1>
        ...
        <div className="container mx-auto px-4">
          <div className="mx-auto grid max-w-5xl gap-8 md:grid-cols-3">
            <div className="rounded-2xl bg-natural-50 p-6 dark:border dark:border-border dark:bg-surface/50">
              ...
              <p className="mt-3 leading-8 text-muted">你仍然需要面对 title、覆盖层、退线、能耗、建筑许可与场地事实。公开规则只是起点，不是自动通行证。</p>
            </div>
            <div className="rounded-2xl bg-natural-50 p-6 dark:border dark:border-border dark:bg-surface/50">
              <h2 className="font-serif text-2xl font-semibold text-fg">它为什么有价值</h2>
              <p className="mt-3 leading-8 text-muted">它可以回应家庭照护、代际居住、隐私需求、客居安排或长期资产配置，而不是只用投机语言去谈这条路径。</p>
            </div>
            <div className="rounded-2xl bg-natural-50 p-6 dark:border dark:border-border dark:bg-surface/50">
              <h2 className="font-serif text-2xl font-semibold text-fg">下一步是什么</h2>
              <p className="mt-3 leading-8 text-muted">最务实的方式不是先做想象图，而是先做可行性判断：规则、title、overlay、access、drainage 与现场约束是否真的支持你前进。</p>
            </div>
          </div>
        </div>
      </section>
