    ...
    <main className="min-h-screen bg-bg py-20">
      <div className="container mx-auto px-4">
        <div className="mx-auto max-w-3xl">
          ...
          <p className="mb-10 text-center text-[1.06rem] leading-8 text-fg/90 dark:text-white/90 md:text-lg">
          ...
          <div className="mt-8 space-y-2 text-center text-[15px] leading-7 text-fg/85 dark:text-white/85 md:text-sm md:leading-6">
