          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <div className="bg-natural-50 rounded-xl p-6">
                <h3 className="text-lg font-bold text-natural-900 mb-3">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {FOUNDING_ROLES.map((role) => (
              <div key={role.id} className="bg-white rounded-2xl p-8 shadow-lg">
                <h3 className="text-2xl font-serif font-bold text-natural-900 mb-4">
                  {role.title}
                </h3>
                <p className="text-natural-600 mb-6">{role.description}</p>
      ...
      <section id="apply" className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-2xl mx-auto">
            ...
            <form onSubmit={handleSubmit} className="space-y-6 bg-natural-50 rounded-2xl p-8">
              <div>
