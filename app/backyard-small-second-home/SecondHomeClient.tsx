...
const houseTypes = [
  { title: 'Garden Studio Retreat', description: 'Light-filled 60 sqm studio. Work, art, or guest stays. All-electric. Compliant.', image: '/images/second-home/garden-studio.jpg', priceRange: '$118k - $168k', size: '60 sqm max' },
  { title: 'Guest Cottage SSD', description: 'Self-contained SSD for parents, in-laws, long-stay guests. Independent. Adjacent.', image: '/images/second-home/guest-cottage.jpg', priceRange: '$80k - $135k', size: '60 sqm max' },
  { title: 'Family Pod & Rental', description: 'Flexible SSD for teens, young adults, or long-term rental. Versatile. Compliant.', image: '/images/second-home/family-pod.jpg', priceRange: '$90k - $169k', size: '60 sqm max' },
  { title: 'Modern Minimalist Studio', description: 'Clean lines. Expansive glass. Sophisticated workspace or guest retreat.', image: '/images/second-home/minimalist-studio.jpg', priceRange: '$70k - $110k', size: '60 sqm max' },
  { title: 'California Bungalow 2BR', description: 'Craftsman-style. Two bedrooms. Wide eaves. Classic charm, modern compliance.', image: '/images/second-home/california-bungalow.jpg', priceRange: '$122k - $168k', size: '60 sqm max' },
  { title: 'Two-Bedroom Family Unit', description: 'Spacious layout. Two bedrooms. Extended family or rental income.', image: '/images/second-home/two-bedroom.jpg', priceRange: '$122k - $168k', size: '60 sqm max' },
]

const useCases = [
  { title: 'Multi-Generational Housing', description: 'Parents or in-laws stay on familiar ground. Dignity. Proximity. Independence.', icon: Heart },
  { title: 'Young Adult Transition', description: 'Semi-independent space for adult children. Study. Work. Rest. Still connected.', icon: Users },
  { title: 'Home Office / Studio', description: 'Dedicated workspace. Separated from domestic life. No commute. Tax-deductible.', icon: Briefcase },
  { title: 'Long-Term Rental Asset', description: 'Victoria rental demand: sub-1% vacancy. Compliant SSD = bankable yield.', icon: Palmtree },
]

const ssdFramework = [
  { constraint: 'Maximum GFA', value: '60 sqm', note: 'No exceptions. This is the ceiling under VC253.', icon: Maximize2 },
  { constraint: 'Siting', value: 'Behind front wall', note: 'SSD must be located behind the front wall line of the main dwelling.', icon: Home },
  { constraint: 'Utilities', value: 'All-electric only', note: 'No reticulated gas connection. Mandated under VC282.', icon: Zap },
  { constraint: 'Ownership', value: 'Same title', note: 'No subdivision. SSD stays on your title permanently.', icon: FileText },
  { constraint: 'Main House POS', value: '25 sqm minimum', note: 'Main dwelling must retain 25 sqm private open space.', icon: Shield },
]
...
export function SecondHomeClient() {
  ...
  const [formData, setFormData] = useState({ name: '', email: '', phone: '', suburb: '', backyardSize: '', propertyType: '', usage: '', timeframe: '' })
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const pageUrl = typeof window !== 'undefined' ? window.location.href : '/backyard-small-second-home'
    try {
      const response = await fetch('/api/second-home', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({ form: formData, utm: attribution, page: pageUrl }),
      })
      const data = await response.json().catch(() => ({}))
      if (response.ok && data?.success) {
        setSubmitStatus('success')
        track('sh_form_submit_success', attribution)
        setFormData({ name: '', email: '', phone: '', suburb: '', backyardSize: '', propertyType: '', usage: '', timeframe: '' })
      } else {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-neutral-900">
            ...
            {houseTypes.map((house, idx) => (
              <div key={idx} className="group bg-neutral-50 dark:bg-neutral-700 rounded-xl overflow-hidden">
                ...
                <div className="p-5">
                  ...
                  <p className="text-base text-muted mb-4">{house.description}</p>
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
            <div className="text-center">
              ...
              <p className="text-base text-muted">Victoria vacancy &lt;1%. Compliant SSD = bankable, recurring income.</p>
            </div>
            <div className="text-center">
              <div className="bg-neutral-900 dark:bg-white rounded-full w-14 h-14 flex items-center justify-center mx-auto mb-4">
              ...
              <p className="text-base text-muted">Quality SSD increases property value. Documented. Compliant. Attractive to buyers.</p>
            </div>
            <div className="text-center">
              <div className="bg-neutral-900 dark:bg-white rounded-full w-14 h-14 flex items-center justify-center mx-auto mb-4">
              ...
              <p className="text-base text-muted">Deemed-to-Comply = bypass planning. Straight to building permit. Certainty.</p>
            </div>
            <div className="text-center">
              <div className="bg-neutral-900 dark:bg-white rounded-full w-14 h-14 flex items-center justify-center mx-auto mb-4">
              ...
              <p className="text-base text-muted">No planning = faster timeline. 6-9 months feasibility to handover. Not 18+.</p>
            </div>
          </div>
        </div>
      </section>
                ...
                return (
                  <div key={idx} className="bg-white dark:bg-neutral-800 rounded-xl p-6">
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <div>
                        <div className="text-base text-muted">{item.constraint}</div>
              ...
              {notForYou.map((item, idx) => (
                <div key={idx} className="flex items-start gap-4 p-5 bg-neutral-50 dark:bg-neutral-700 rounded-xl border-l-4 border-neutral-900 dark:border-neutral-500">
                  ...
                  <div>
                    ...
                    <div className="text-base text-muted">{item.reason}</div>
                  </div>
                </div>
              ))}
            </div>
      ...
      <section className="py-6 bg-white dark:bg-neutral-800 border-t border-neutral-100 dark:border-neutral-700">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <p className="text-sm text-muted mb-2 uppercase tracking-widest">Also Known As</p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-2xl mx-auto">
            <div className="text-center mb-10">
              <div className="text-sm font-mono text-white/90 mb-4 uppercase tracking-widest">Entry Gate</div>
            ...
            <div className="bg-white rounded-xl p-8 text-neutral-900">
              <form onSubmit={handleSubmit} className="space-y-5">
                <div className="grid md:grid-cols-2 gap-5">
                  <div>
                    <label htmlFor="ssd-name" className="block text-base font-medium text-fg mb-1.5">Name *</label>
                  ...
                  <div>
                    <label htmlFor="ssd-email" className="block text-base font-medium text-fg mb-1.5">Email *</label>
                ...
                <div className="grid md:grid-cols-2 gap-5">
                  <div>
                    <label htmlFor="ssd-phone" className="block text-base font-medium text-fg mb-1.5">Phone</label>
                  ...
                  <div>
                    <label htmlFor="ssd-suburb" className="block text-base font-medium text-fg mb-1.5">Suburb (VIC) *</label>
                ...
                <div className="grid md:grid-cols-2 gap-5">
                  <div>
                    <label htmlFor="ssd-lotsize" className="block text-base font-medium text-fg mb-1.5">Lot Size (sqm) *</label>
                  ...
                  <div>
                    <label htmlFor="ssd-use" className="block text-base font-medium text-fg mb-1.5">Primary Use *</label>
                ...
                <div>
                  <label htmlFor="ssd-timeline" className="block text-base font-medium text-fg mb-1.5">Timeline</label>
                ...
                <Button type="submit" variant="primary" size="lg" className="w-full bg-neutral-900 hover:bg-neutral-800" disabled={isSubmitting}>
                ...
                {submitStatus === 'error' && (
                  <div className="p-4 bg-red-50 border border-red-200 rounded-lg text-center">
                    <p className="text-red-800">Submission failed. Email leonzh@bayviewestate.com.au directly.</p>
                  </div>
                )}
              </form>
            </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <div className="text-center mb-6">
              <p className="text-base font-medium text-muted mb-2">Victorian SSD Regulatory Compliance Service</p>
              <p className="text-sm text-muted">Registered VicSmart Pathway Provider · Clause 54.03 Deemed-to-Comply Specialist</p>
            </div>
