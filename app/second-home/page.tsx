...
const houseTypes = [
  {
    ...
    description: 'A light-filled garden studio for work, art, or quiet guest stays. Perfect for creative pursuits and peaceful mornings.',
  ...
  },
  {
    ...
    description: 'A self-contained granny flat ideal for parents, in-laws, or long-stay guests. Independent living with nearby connection.',
  ...
  },
  {
    ...
    description: 'A flexible small second home for teens, young adults or short-stay rentals. Versatile design for changing needs.',
  ...
  },
  {
    ...
    description: 'Ultra-contemporary design with clean lines and expansive glass. Perfect for those seeking a sleek, sophisticated workspace or guest retreat.',
  ...
  },
  {
    ...
    description: 'Craftsman-style bungalow with two bedrooms, featuring wide eaves, tapered columns, and a welcoming front porch. Classic charm with modern comfort.',
  ...
  },
  {
    ...
    description: 'Spacious layout with two bedrooms and open living areas. Ideal for extended family living or generating substantial rental income.',
...
const useCases = [
  {
    ...
    description: 'Independent, nearby living with dignity and closeness. Help aging parents stay on familiar ground while maintaining their independence.',
    icon: Heart,
  },
  {
    title: 'Teen or Young Adult Space',
    description: 'Semi-independent area for study, music, creativity and rest. Give young adults space to grow while staying connected.',
    icon: Users,
  },
  {
    title: 'Home Office or Creative Studio',
    description: 'A quiet, focused workspace away from the main house. Separate work from home life with a dedicated sanctuary.',
    icon: Briefcase,
  },
  {
    title: 'Short-Stay Rental or Airbnb',
    description: 'Tap into Victorian tourism demand with a tasteful, private stay. Generate income from visitors year-round.',
    icon: Palmtree,
  },
]
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <Button href="#house-types" variant="outline" size="lg">
                View House Types
              </Button>
            </div>
          </div>
            ...
            {houseTypes.map((house, idx) => (
              <div key={idx} className="group bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-shadow dark:bg-primary-900/60 dark:border dark:border-primary-700">
                ...
                <div className="p-6">
                  ...
                  <Button 
                    href={`mailto:leonzh@bayviewestate.com.au?subject=Interest in Small Second Home - ${house.title}&body=Hi, I'm interested in learning more about the ${house.title}.`}
                    variant="primary"
                    size="sm"
                    className="w-full"
                  >
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg max-w-none text-natural-700 space-y-6 dark:text-natural-200 dark:prose-invert">
              ...
              <p className="text-xl leading-relaxed">
                These are spaces designed for art, books, and slow mornings. Spaces that feel connected to the land and the changing seasons of Victoria.
              </p>
              <p className="text-xl leading-relaxed">
                Our small second homes carry the same thoughtful approach you'll find across the broader Bayview ecosystem:
              </p>
              <ul className="space-y-2 text-lg">
                <li><strong>Bayview Arts & Framing Studio</strong> — Custom framing and gallery space</li>
                <li><strong>Pig & Whistle / Bayview Estate</strong> — Hospitality and gathering spaces</li>
                <li><strong>Market Garden Project</strong> — Sustainable local food growing</li>
                <li><strong>Mend</strong> — Digital reflection platform</li>
              </ul>
            </div>
          </div>
        </div>
              ...
              {[
                {
                  ...
                  description: 'You share your property details, goals and timeframe. We listen and ask questions to understand what you\'re hoping to create.',
                },
                {
                  step: '2',
                  title: 'Feasibility & Concept',
                  description: 'We map potential layouts, highlight council considerations, and outline a budget range. This stage helps you decide if it\'s the right fit.',
                },
                {
                  step: '3',
                  title: 'Design & Approvals',
                  description: 'We guide you through detailed design and, with local professionals, help navigate planning and building permits across Victoria.',
                },
                {
                  step: '4',
                  title: 'Build & Bayview Finishing Touches',
                  description: 'Your second home is built and optionally finished with styling and garden touches that reflect the Bayview feel. Move in and enjoy.',
                },
              ].map((item, idx) => (
                <div key={idx} className="flex items-start space-x-6">
                  ...
                  <div>
                    <h3 className="text-2xl font-serif font-bold text-natural-900 mb-3">
                      {item.title}
                    </h3>
                    <p className="text-natural-700 leading-relaxed text-lg">
                      {item.description}
                    </p>
                  </div>
                </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="prose prose-lg max-w-none text-natural-700 space-y-6">
              <p className="text-xl leading-relaxed">
                Bayview Backyard Second Home is part of <strong>Bayview Estate Holdings</strong>, a collection of businesses and projects that share a common philosophy: creating physical and digital spaces where families slow down, reconnect and feel at home.
              </p>
              <p className="text-xl leading-relaxed">
                Alongside Bayview Backyard Second Home, the Bayview family includes:
              </p>
              <ul className="space-y-2 text-lg">
                <li><strong>Bayview Arts & Framing Studio</strong> – custom framing and gallery space</li>
                <li><strong>Pig & Whistle / Bayview Estate</strong> – hospitality and gathering</li>
                <li><strong>Market Garden Project</strong> – sustainable local food growing</li>
                <li><strong>Mend</strong> – a digital reflection platform</li>
              </ul>
              <p className="text-xl leading-relaxed">
                Each of these projects reflects our belief in thoughtful design, connection to place, and making space for what matters most.
              </p>
            </div>
          </div>
        </div>
